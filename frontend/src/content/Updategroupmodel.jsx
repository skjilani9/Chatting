...
const Updategroupmodel = ({ fetchchata, fetchAgain, setFetchAgain }) => {
    ...
    const handleRename = async () => {
        ...
        try {
            ...
            const { data } = await axios.put(
                `https://chat-8wv9.onrender.com/api/v1/rename`,
                {
    ...
    const handleAddUser = async (user1) => {
        ...
        try {
            ...
            const { data } = await axios.put(
                `https://chat-8wv9.onrender.com/api/v1/groupadd`,
                {
                    chatId: selectedChat._id,
                    userId: user1._id,
                },
    ...
    const handleRemove = async (user1) => {
        ...
        try {
            ...
            const { data } = await axios.put(
                `https://chat-8wv9.onrender.com/api/v1/groupremove`,
                {
                    chatId: selectedChat._id,
                    userId: user1._id,
                },
